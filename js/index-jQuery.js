$(function(){
	...
	//banner图轮播
 	function rollOne(){  
	    $(".big-img >ul").animate({marginLeft:"-1519px"},2000,"linear",function(){
	...
	function rolltwo(){
        ...
        console.log(imgw);
    $(".hualist-ul").animate({marginLeft:`-${imgw}px`},2000,"linear",function(){
        $(this).css({marginLeft:"0px"});
        $(this).children("li").first().remove().clone(true).appendTo(".hualist-ul");
    });
	}
